import{j as e}from"./jsx-runtime-AgcCsxC8.js";import{I as s}from"./icon-bJ_1onUt.js";import{B as d}from"./button-vZ_4xn-b.js";import"./index-XiNr8FW2.js";import"./_commonjsHelpers-5-cIlDoe.js";import"./index-bittVVcR.js";import"./index-iqSuTeQG.js";import"./index-hnMjDxAq.js";const B={title:"Icon",component:s,tags:["autodocs"]},c={args:{icon:"check",size:"3x"}};c.storyName="默认图标";const r={args:{icon:"check",theme:"danger",size:"3x"}};r.storyName="不同主题的 Icon";const n=()=>e.jsxs("div",{style:{display:"flex",justifyContent:"space-around"},children:[e.jsx(s,{icon:"check",size:"3x"}),e.jsx(s,{icon:"times",size:"3x"}),e.jsx(s,{icon:"anchor",size:"3x"}),e.jsx(s,{icon:"trash",size:"3x"}),e.jsxs(d,{size:"lg",btnType:"primary",children:[e.jsx(s,{icon:"check"})," check"," "]}),e.jsx(s,{icon:"check",size:"3x",theme:"theme"}),e.jsx(s,{icon:"times",size:"3x",theme:"danger"}),e.jsx(s,{icon:"anchor",size:"3x",theme:"primary"}),e.jsx(s,{icon:"exclamation-circle",size:"3x",theme:"warning"}),e.jsx(s,{icon:"spinner",size:"3x",theme:"primary",spin:!0}),e.jsx(s,{icon:"spinner",size:"3x",theme:"success",pulse:!0})]});n.storyName="示例Icon";var o,i,t;c.parameters={...c.parameters,docs:{...(o=c.parameters)==null?void 0:o.docs,source:{originalSource:`{
  args: {
    /**设置 icon 图标*/
    icon: "check",
    size: "3x"
